...
data("kinase_data")
```
# Summary statistics for DNA polymerase data
summary(dna_pol_data)

# Plot amino acid proportions for kinases
plot_aa_proportions(kinase_data)

# Compare sequence lengths between DNA polymerases and kinases
compare_sequence_lengths(dna_pol_data, kinase_data)
